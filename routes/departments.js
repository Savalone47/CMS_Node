...
router.get("/", (req, res) => {
    ...
    db.all(sqlQuery, (err, rows) => {
        ...
        // res.send(rows);
        res.render("../views/departments.ejs", { departments: rows });
...
router.get("/:name/instructors/create", (req, res) => {
    ...
    res.render('../views/addInstructorToDept.ejs', { name: name });
});

router.get("/create", (req, res) => {
    res.render('../views/createDepartment.ejs');
});
...
router.get("/:name", (req, res) => {
    ...
    db.get(sqlQuery, [req.params.name], (err, rows) => {
        ...
        // res.send(rows);
        res.render("../views/departmentByName.ejs", { department: rows });
    });
});
...
router.get("/:name/instructors", (req, res) => {
    ...
    db.all(sqlQuery, [req.params.name], (err, rows) => {
        ...
        // res.send(rows);
        res.render("../views/deptInstructors.ejs", { instructors: rows });
    });
});
...
router.get("/:name/students", (req, res) => {
    ...
    db.get(sqlQuery, [req.params.name], (err, rows) => {
        ...
        // res.send(rows);
        res.render("../views/deptStudents.ejs", { student: rows });
    });
});
